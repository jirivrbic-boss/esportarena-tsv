...
export function GlowButton({
  ...
  const base =
    "relative box-border inline-flex max-w-full items-center justify-center whitespace-nowrap rounded-lg px-6 py-3 text-sm font-semibold uppercase leading-tight tracking-wider transition-shadow touch-manipulation focus:outline-none focus-visible:ring-2 focus-visible:ring-[#39FF14] focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505]";
  const styles =
    variant === "primary"
